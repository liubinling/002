...
import com.bca.toolkit.top.tools.orm.creator.PojoSourceCreator_4_Hibernate;
 ...
 * @author pxz
 */
public class BcaTool_PojoFac_BcaHibernate extends javax.swing.JPanel implements I_PojoFactoryForm, ListSelectionListener {
     ...
     */
    public BcaTool_PojoFac_BcaHibernate(BcaTool_PojoCreatePanel pojoCreatePanel) {
        initComponents();
        //
    ...
    private void initComponents() {
        ...
        usePackageClassBox = new javax.swing.JCheckBox();
        ...
        jLabel11.setText("字符集:");

        charsetBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "GBK", "utf-8" }));

        usePackageClassBox.setText("使用包装类");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(charsetBox, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(usePackageClassBox)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(charsetBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(usePackageClassBox))
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(flagsField, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
        ...
        mapTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "字段名", "数据类型", "标志", "变量名", "变量类型", "作用域", "字段注释", "toString", "equals", "hashCode"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Boolean.class, java.lang.Boolean.class, java.lang.Boolean.class
            };
    ...
    private void saveFieldAttrButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveFieldAttrButtonActionPerformed
        ...
        pojoField.varType = (String) vartypeBox.getSelectedItem();
        ...
        col++;   // comment  // tm.setValueAt("", row, col++);
...
//                    new Object[] {col.getSqlName(), col.getSqlTypeNameWithLenInfo(), col.getFlags(), f.varName, f.varType, f.scope, f.inToString, f.inEquals, f.inHashCode});
    ...
    private void savePojoAttrButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePojoAttrButtonActionPerformed
        ...
        // 
        model.pojoAttr.usePackageClassFlag = usePackageClassBox.isSelected();
        // 
...
//        
        Uitool.setTableColumnWidths(mapTable, new int[]{150, 120, 60, 120, 120, 120, 120, 70, 70, 70});
    ...
    public void reloadORM() {
        ...
        for (PojoField f : model.pojoFields.values()) {
            ...
            tm.addRow(new Object[]{col.getSqlName(), col.getSqlTypeNameWithLenInfo(), col.getFlags(), f.varName, f.varType, f.scope, col.getColComment(), f.inToString, f.inEquals, f.inHashCode});
        }
    ...
    javax.swing.JComboBox charsetBox;
    ...
    javax.swing.JCheckBox usePackageClassBox;
...
//
    ...
    public I_PojoSourceCreator getSourceCreator() {
        I_PojoSourceCreator c = new PojoSourceCreator_4_Hibernate();
        c.setCharset((String) charsetBox.getSelectedItem());
        return c;
    }
}
