 ...
 * @author David Kaspar
 */
public class VNodeAnchor extends Anchor {
     ...
     */
    public VNodeAnchor (Widget widget) {
        this (widget, true);
    }
     ...
     */
    public VNodeAnchor (Widget widget, boolean vertical) {
        this (widget, vertical, VFactory.getOriginalScheme ());
    }
     ...
     * @since 2.5
     */
    public VNodeAnchor (Widget widget, boolean vertical, VColorScheme scheme) {
        super (widget);
        assert widget != null;
        assert scheme != null;
