 ...
 * @author David Kaspar
 */
public class VConnectionWidget extends ConnectionWidget {
     ...
     */
    public VConnectionWidget (Scene scene, Router router) {
     ...
     */
    public VConnectionWidget (Scene scene, VColorScheme scheme) {
        super (scene);
        assert scheme != null;
        this.scheme = scheme;
