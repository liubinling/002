...
/**
 * This class represents a pin widget in the V visualization style.
 * The pin widget consists of a name and a glyph set.
 *
 * @author David Kaspar
 */
public class VPinWidget extends Widget {

    private VColorScheme scheme;

    private LabelWidget nameWidget;
    private VGlyphSetWidget glyphsWidget;
    private VNodeAnchor anchor;

    /**
     * Creates a pin widget.
     * @param scene the scene
     */
    public VPinWidget (Scene scene) {
        this (scene, VFactory.getOriginalScheme ());
    }
     ...
     */
    public VPinWidget (Scene scene, VColorScheme scheme) {
        super (scene);
        assert scheme != null;
        this.scheme = scheme;
        ...
        addChild (glyphsWidget = new VGlyphSetWidget (scene));
    ...
    /**
     * Creates a horizontally oriented anchor similar to VNodeWidget.createAnchorPin
     * @return the anchor
     */
    public Anchor createAnchor () {
        if (anchor == null)
            anchor = new VNodeAnchor (this, false);
        return anchor;
    }
