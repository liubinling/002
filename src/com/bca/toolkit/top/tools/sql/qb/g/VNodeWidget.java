 ...
 * @author David Kaspar
 */
public class VNodeWidget extends Widget implements StateModel.Listener, VMinimizeAbility {
    ...
    private VGlyphSetWidget glyphSetWidget;
     ...
     */
    public VNodeWidget (Scene scene) {
     ...
     */
    public VNodeWidget (Scene scene, VColorScheme scheme) {
        super (scene);
        assert scheme != null;
        this.scheme = scheme;

        nodeAnchor = new VNodeAnchor (this, true, scheme);
        ...
        glyphSetWidget = new VGlyphSetWidget (scene);
     ...
     * An anchor (created by <code>VNodeWidget.createPinAnchor</code> is not affected by this method.
