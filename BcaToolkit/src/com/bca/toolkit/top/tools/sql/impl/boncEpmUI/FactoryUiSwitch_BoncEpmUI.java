 ...
 * @author pxz
 */
public class FactoryUiSwitch_BoncEpmUI extends javax.swing.JDialog implements I_UiSwitch {

    SqlCreateModel sqlModel;
    private boolean reloadModelRequest = false;

    /** Creates new form FactoryUiSwitch_Hxhk */
    public FactoryUiSwitch_BoncEpmUI() {
...
private void restButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restButtonActionPerformed
    ...
    public void loadSwitches(SqlCreateModel sqlModel) {
        ...
        listdevBox.setSelected(!sqlModel.isFieldMasked("ui", "listdev"));
        addBox.setSelected(!sqlModel.isFieldMasked("ui", "add"));
        updateBox.setSelected(!sqlModel.isFieldMasked("ui", "update"));
        viewBox.setSelected(!sqlModel.isFieldMasked("ui", "view"));
    ...
    private void updateUiSwitches() {
        ...
        setMaskSwitch(listdevBox.isSelected(), "listdev");
        setMaskSwitch(addBox.isSelected(), "add");
        setMaskSwitch(updateBox.isSelected(), "update");
        setMaskSwitch(viewBox.isSelected(), "view");
