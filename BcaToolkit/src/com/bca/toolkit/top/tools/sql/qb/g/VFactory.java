 ...
 * @author David Kaspar
 */
public final class VFactory {

    private static VColorScheme SCHEME_ORIGINAL = new VOriginalColorScheme ();
    private static VColorScheme SCHEME_NB60 = new VNetBeans60ColorScheme ();
     ...
     * @since 2.5
     */
    public static VColorScheme getOriginalScheme () {
     ...
     * @since 2.5
     */
    public static VColorScheme getNetBeans60Scheme () {
        return SCHEME_NB60;
    }
     ...
     */
    public static Border createVNodeBorder () {
        return VOriginalColorScheme.BORDER_NODE;
    }
     ...
     * @since 2.5
     */
    public static Border createVNodeBorder (Color borderColor, int borderThickness, Color color1, Color color2, Color color3, Color color4, Color color5) {
        return new VNodeBorder (borderColor, borderThickness, color1, color2, color3, color4, color5);
    }
