 ...
 * @author pxz
 */
public class FactoryUiSwitch_GuoXin extends javax.swing.JDialog implements I_UiSwitch {

    SqlCreateModel sqlModel;
    private boolean reloadModelRequest = false;

    /** Creates new form FactoryUiSwitch_GuoXin */
    public FactoryUiSwitch_GuoXin() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(FactoryUiSwitch_GuoXin.class, "FactoryUiSwitch_GuoXin.jLabel2.text")); // NOI18N
        jLabel2.setName("jLabel2"); // NOI18N

        compPerRowField.setText(org.openide.util.NbBundle.getMessage(FactoryUiSwitch_GuoXin.class, "FactoryUiSwitch_GuoXin.compPerRowField.text")); // NOI18N
        compPerRowField.setName("compPerRowField"); // NOI18N

        confirmReplaceAtDosBox.setSelected(true);
        confirmReplaceAtDosBox.setText(org.openide.util.NbBundle.getMessage(FactoryUiSwitch_GuoXin.class, "FactoryUiSwitch_GuoXin.confirmReplaceAtDosBox.text")); // NOI18N
        confirmReplaceAtDosBox.setName("confirmReplaceAtDosBox"); // NOI18N

        restButton.setText(org.openide.util.NbBundle.getMessage(FactoryUiSwitch_GuoXin.class, "FactoryUiSwitch_GuoXin.restButton.text")); // NOI18N
        ...
        saveButton.setText(org.openide.util.NbBundle.getMessage(FactoryUiSwitch_GuoXin.class, "FactoryUiSwitch_GuoXin.saveButton.text")); // NOI18N
