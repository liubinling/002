 ...
 * @author pxz
 */
public class Cf_DbwizOptionDialog extends javax.swing.JDialog implements I_FactoryOptDlg {

    public Cf_DbwizOptionDialog() {
    ...
    private void initComponents() {
        ...
        setTitle("BCA代码工厂--选项(DB代码片段)"); // NOI18N
        setName("Form"); // NOI18N
        ...
        getAccessibleContext().setAccessibleName("BCA代码工厂--选项(翰科框架)");
