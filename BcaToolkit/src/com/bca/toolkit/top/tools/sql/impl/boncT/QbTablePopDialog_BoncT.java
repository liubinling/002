 ...
 * @author pxz
 */
public class QbTablePopDialog_BoncT extends javax.swing.JDialog implements I_ColBatchDlg {
...
//        this.qbJTable = qbJTable;
    ...
    private void initComponents() {
        ...
        viewMask.setActionCommand(org.openide.util.NbBundle.getMessage(QbTablePopDialog_BoncT.class, "QbTablePopDialog_BoncT.viewMask.actionCommand")); // NOI18N
...
private void unbindingSeqButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_unbindingSeqButtonActionPerformed
    ...
    public void wfinit(QbJTable jtable) {
        ...
        this.setTitle(String.format("表<%s>:列批量动作 (BONCT框架)", qbJTable.getModel().getTbean().getTableDetail().getName()));
    }
